...
_DEFAULT_CLASSIFICATIONS: list[dict] = [
    ...
    {"major": "发动机", "minor": "排气异常", "keywords": ["排气大", "下排气", "排温", "排气温度", "消声器", "排气管", "SCR", "DPF", "尿素", "排气管异响", "排气异响"]},
    ...
    {"major": "变速箱", "minor": "换挡/离合器", "keywords": ["换挡", "挡位", "离合器", "倒挡", "不增档", "不减档", "变速箱异响"]},
    ...
    {"major": "液压系统", "minor": "液压通用", "keywords": ["液压", "液压异响"]},
    # ── 电气系统 ──
    ...
    {"major": "制动系统", "minor": "制动通用", "keywords": ["刹车", "制动", "驻车", "刹车片", "刹车盘", "刹车异响", "制动异响"]},
    # ── 转向系统 ──
    ...
    {"major": "空调", "minor": "空调故障", "keywords": ["空调不工作", "空调没有", "空调异响", "空调", "不制冷", "无冷气"]},
    # ── 事故/损失 ──
    ...
    {"major": "日常维护", "minor": "润滑系统保养", "keywords": ["加注黄油", "充黄油", "打点油", "打点润滑", "补加黄油", "已充.*黄油", "已加注.*黄油", "公斤黄油", "黄油箱"]},
    ...
    {"major": "日常维护", "minor": "保养通用", "keywords": ["保养"]},
]
