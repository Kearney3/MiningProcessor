...
_DEFAULT_CLASSIFICATIONS: list[dict] = [
    {"major": "发动机系统", "minor": "发动机总成/大修", "keywords": ["发动机在ub维修", "发动机在维修中", "发动机准备发到", "发动机备件", "发动机安装", "发动机拆解", "诊断发动机", "检修发动机", "待修发动机", "发动机大修", "发动机在大修", "维修发动机", "发动机维修", "发动机总成", "发动机报废", "发动机抱死", "发动机坏", "更换发动机", "等待发动机", "拆卸发动机", "发动机发到", "发动机运到", "装发动机"]},
    ...
    {"major": "发动机系统", "minor": "性能/工况异常", "keywords": ["发动机黄灯", "发动机黄色灯", "发动机出现问题", "发动机没劲", "发动机没劲儿", "发动机无力", "发动机异响", "发动机冒烟", "发动机冒黑烟", "发动机冒白烟", "发动机冒蓝烟", "发动机熄火", "发动机高温", "发动机报警", "发动机故障"], "all_keywords": [["发动机", "报警"], ["发动机", "异常"]], "priority": -5},
...
_FAULT_MARKERS = (
    ...
    "渗油", "渗", "异响", "磨损", "破裂", "断裂", "裂纹", "无力", "高温", "压力异常",
